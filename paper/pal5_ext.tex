...
As such, to learn about external galaxies' dark matter, mass profiles and orbit structures, we need methods to detect their thin, GC stellar streams. However, GC streams have lower masses and are thinner than streams from dwarf galaxies, and GC streams are therefore harder to detect in external galaxies. Interestingly, \citet{abraham18} reported a detection of the ``Maybe Stream" with HST, which they suggest could be a GC stream 20 Mpc away. 
